...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2021/11/02 15:46:31 by maiwenn           #+#    #+#             */
/*   Updated: 2021/11/02 15:46:32 by maiwenn          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	MandelbulbMesh::render(Camera &cam, float timeS, std::vector<Mesh*> &lights, Vec2 resolution)
{
	Vec3	camPos;
	Vec3	modelPos;
